 ...
 */
public class SlidesTokenValidationFilter extends SecurityFilter implements Filter {
	 ...
	 * @param excludes
	 */
    public SlidesTokenValidationFilter(final Config config, final String clients, final String authorizers, String[] excludes) {
