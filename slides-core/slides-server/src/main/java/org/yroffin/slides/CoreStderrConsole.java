 ...
 */
@Component
public class CoreStderrConsole extends OutputStream {
	protected static Logger logger = LoggerFactory.getLogger(CoreStderrConsole.class);
