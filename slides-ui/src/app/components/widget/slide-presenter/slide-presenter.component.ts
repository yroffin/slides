...
@Component({
  ...
  styleUrls: ['./slide-presenter.component.css']
})
export class SlidePresenterComponent implements OnInit {

  public slideStream: Observable<SlideBean> = new Observable<SlideBean>();
